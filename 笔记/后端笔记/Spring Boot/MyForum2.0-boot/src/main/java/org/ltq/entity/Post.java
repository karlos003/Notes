...
public class Post {
	...
	public Post(String user_account, Date post_time) {
		super();
		this.user_account = user_account;
		this.post_time = post_time;
	}

	public Post(BigInteger post_id, String post_type, String post_title, String post_content, String user_account,
			String user_name, Date post_time, List<BigInteger> comment_id) {
		super();
	...
	public Post(BigInteger post_id, String post_type, String post_title, String post_content, String user_account,
			String user_name, Date post_time, int image, List<BigInteger> comment_id) {
		super();
		this.post_id = post_id;
		this.post_type = post_type;
		this.post_title = post_title;
