...
<body>
	...
	<form action="userController/changePasswordControl" onsubmit="return valid()">
		原密码：<input type="password" name="currentPwd" id="currentPwd" required="required" maxlength="15"><br/>
		输入新密码：<input type="password" name="pwd" required="required" maxlength="15"><br/>
